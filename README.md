...
- Consultez la section [Outils de jumelage manuscrit/revue](https://bib.umontreal.ca/gerer-diffuser/communication-savante/publier-article-scientifique). Notez que ces outils ne sont pas neutres car ils servent souvent à faire la promotion des revues des éditeurs qui les proposent. Parmi ceux-ci, il semble que l'outil [B!SON](https://service.tib.eu/bison/) sorte du lot en analysant les titres et résumés avec DOAJ et la bibliographie avec OpenCitations. 
